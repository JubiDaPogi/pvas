...
<div class="pvas-page-wrap">
    <div class="pvas-page-heading">
        <h2>Our Services</h2>
        <p>Everything we offer for your pet, filter by type or search below.</p>
    </div>
    <div class="pvas-services-layout">
        <aside class="pvas-category-sidebar">
            <h3>Categories</h3>
        ...
        <div class="pvas-service-main">
            <div class="pvas-service-search">
                <i class="fa fa-search"></i>
                <input type="text" id="search" class="form-control form-control-sm" placeholder="Search a service...">
            </div>
            ...
            <?php endwhile; ?>
            <div id="no_result" class="text-center text-muted py-4" style="display:none;">
                <i class="fa fa-search mb-2 d-block"></i> No services matched your search.
            </div>
        </div>
        </div>
    </div>
